                      ...
                      <MDBCardBody className="p-4 justify-content-center align-content-center">
                        <div className="d-col text-black justify-content-center align-content-center">
                          <div className="flex-grow-1 m-4">
                            ...
                            <MDBCardText>
                              <strong>Chip:</strong> {pet.pet_chip_number}
                            </MDBCardText>
                            <MDBCardText>
                              <strong>Raza:</strong> {pet.pet_breed}
                            </MDBCardText>
                            <div
                            ...
                            >
                              <div>
                                <p className="small text-muted mb-1">Tamaño</p>
                                <p className="mb-0">{pet.pet_height} cm</p>
                              </div>
                              <div className="px-3">
                                <p className="small text-muted mb-1">Peso</p>
